...
const Points = () => {
  ...
  const [inticialPosition, setInitialPosition] = useState<[number, number]>([0, 0]);
    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.mapContainer}>
          {inticialPosition[0] !== 0 && (
            <MapView style={styles.map} initialRegion={{ latitude: inticialPosition[0], longitude: inticialPosition[1], latitudeDelta: 0.014, longitudeDelta: 0.014 }}>
              {points.map(point => (
